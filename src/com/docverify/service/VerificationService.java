...
public class VerificationService {
    ...
    public VerificationResult verifyDocument(String documentId, String currentHash)
            throws DocumentNotFoundException, TamperDetectedException {
        Document document = documentService.findDocumentById(documentId);
 
        if (!Objects.equals(document.getDocumentHash(), currentHash)) {
            ...
            throw new TamperDetectedException("Tampering detected for document: " + documentId);
        }
